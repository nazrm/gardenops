...
ADMIN_EDGE_LOCATION_RULES: Final[tuple[AdminEdgeLocationRule, ...]] = (
    ...
    AdminEdgeLocationRule(
        ...
        bucket="admin_write",
        rationale="Snapshot list/create shares one path and keeps the stricter bucket.",
    ),
    AdminEdgeLocationRule(
        match_kind="prefix",
        pattern="/api/snapshots/",
        bucket="admin_write",
        rationale="Snapshot restore/delete paths.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
    ...
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/mfa/totp/start",
        bucket="admin_write",
        rationale="Admin MFA enrollment start.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/mfa/totp/confirm",
        bucket="admin_write",
        rationale="Admin MFA enrollment confirm.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/mfa/disable",
        bucket="admin_write",
        rationale="Admin MFA disable.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/mfa/recovery-codes/regenerate",
        bucket="admin_write",
        rationale="Admin recovery-code regeneration.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/users",
        bucket="admin_write",
        rationale="User list/create exact path.",
    ),
    AdminEdgeLocationRule(
        match_kind="prefix",
        pattern="/api/auth/users/",
    ...
    AdminEdgeLocationRule(
        ...
        bucket="admin_write",
        rationale="Invitation list/create exact path.",
    ),
    AdminEdgeLocationRule(
        match_kind="prefix",
        pattern="/api/auth/user-invitations/",
    ...
    AdminEdgeLocationRule(
        ...
        bucket="admin_write",
        rationale="Cross-user session revoke.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/revoke-all-sessions",
        bucket="admin_write",
        rationale="Global session revoke.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
        pattern="/api/auth/emergency-read-only",
        bucket="admin_write",
        rationale="Emergency-read-only status/toggle exact path.",
    ),
    AdminEdgeLocationRule(
        match_kind="regex",
        pattern=r"^/api/gardens/[0-9]+$",
        bucket="admin_write",
        rationale="Garden deletion path.",
    ),
    AdminEdgeLocationRule(
        match_kind="regex",
        pattern=r"^/api/gardens/[0-9]+/invitations(?:/[0-9]+)?$",
        bucket="admin_write",
        rationale="Garden invitation list/create/revoke paths.",
    ),
    AdminEdgeLocationRule(
        match_kind="exact",
