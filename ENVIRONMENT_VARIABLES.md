...
| `AUTH_MFA_SECRET_KEY` | Secret key for MFA state encryption/signing. Production and internet-exposed session-auth deployments require at least 32 characters. | `generate-at-least-32-random-characters` |
