...
const PREFERENCE_RULE_ROWS: PreferenceRuleRow[] = [
  {
    id: "routine-tasks",
    ruleKeys: ["task_due", "needs_action"],
  ...
  {
    id: "weather-warnings",
    ruleKeys: ["warning", "frost_warning", "rain_alert"],
  ...
  {
    id: "upcoming-work",
    ruleKeys: ["upcoming", "calendar_event_due", "calendar_event_upcoming"],
...
export function initAttentionTodayPanel(
  ...
  function showPreferencesDialog(
    ...
    (["digest", "interruptive"] as const).forEach((channel) => {
      const quietRow = document.createElement("label");
