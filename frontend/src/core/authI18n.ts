...
const translations: Record<Locale, Record<string, TranslationEntry>> = {
  en: {
    ...
    "identity.passkeys.final_factor_required": "Add another passkey or enable password authentication before removing this passkey.",
  ...
  no: {
    ...
    "identity.passkeys.final_factor_required": "Legg til en annen passnøkkel eller aktiver passordinnlogging før du fjerner denne passnøkkelen.",
